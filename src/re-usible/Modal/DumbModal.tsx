...
const DumbModal: React.FC<ModalProps> = ({handleClose, open, selectedFile, handleFileChange, handleUploadImage}) => (
    <div>
        <Modal
            ...
            <Fade in={open}>
                <Box sx={style}>
                    <UploadContainer>
                        ...
                        {selectedFile ? <UploadButton onClick={handleUploadImage}>Upload Image</UploadButton> :
